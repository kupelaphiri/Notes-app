...
const deleteAll = () => {
  ...
  return (
    <div className={` flex ${deletedNotes == null ? 'justify-center items-center' : ''} ${isLoading? 'flex justify-center pt-[200px] items-center' : ''} ${isDark? 'bg-dim': ''}`}>
      {isLoading? (
         <l-ring
         size="40"
         stroke="5"
      ...
      <div className={`flex flex-col h-screen ${deletedNotes == null ? 'items-center justify-center' : ''} w-full overflow-y-auto pb-[100px]`}>
      {deletedNotes == null ? (
        <>
        <div>
      ...
      <div className="flex flex-col h-screen w-full overflow-y-auto pb-[100px]">
        ...
        {isOn ? (
         ...
         {deletedNotes.map((note) => {
              return (
                  ...
                  <div key={note.id} className={`w-[280px] flex flex-col group min-h-24 max-h-[452px] overflow-hidden border-[1px] mt-[20px] pt-2 rounded-md mr-4 ${isOn? 'w-[597px]' : ''}`}>
                    ...
                    <svg onClick={()=>restoreNote(note._id)} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="invisible group-hover:visible mt-[5px] w-[20px] cursor-pointer">
                    ...
                    <svg onClick={()=>permanentDelete(note._id)} className='invisible group-hover:visible mt-[7px] mr-1 w-[20px] cursor-pointer' viewBox="0 0 48 48"  xmlns="http://www.w3.org/2000/svg">
        ...
        {deletedNotes.map((note) => {
             return (
                 ...
                 <div key={note.id} className={`w-[280px] group flex flex-col min-h-24 max-h-[452px] overflow-hidden border-[1px] mt-[20px] pt-2 rounded-md mr-4 ${isOn? 'w-[597px]' : ''}`}>
                   <div className='w-full h-full pr-3 text-ellipsis pl-3 pb-8'>
                   <h2 className='text-xs'>{note.title}</h2>
                   <p className='text-xs'>{note.body}</p>
                     </div>
