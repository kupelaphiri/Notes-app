  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
   ...
   {searchResults.map((note) => {
        return (
            ...
            <div key={note.id} className={`flex flex-col w-[240px] group hover:shadow-lg cursor-pointer flex-1 min-h-24 max-h-[452px] overflow-hidden border-[1px] mt-[20px] pt-2 rounded-lg mr-4`}>
              <div className='w-full h-full pr-3 mb-5 overflow-hidden text-ellipsis pl-3 pb-9'
               onClick={()=> {
                setModalData(note)
                setModalTitle(note);
                setModalBody(note)
              ...
              <svg onClick={()=>permanentDelete(note._id)} className='invisible w-[20px] cursor-pointer group-hover:visible' viewBox="0 0 48 48"  xmlns="http://www.w3.org/2000/svg">
